    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md animate-slide-up">
          <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-lg shadow-slate-200/60 text-center">
            ...
            <h1 className="text-xl font-bold text-slate-900 mb-2">E-mail envoyé</h1>
            <p className="text-slate-500 text-sm mb-6">
              Si un compte est associé à <strong className="text-slate-700">{email}</strong>,
    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-8 sm:py-12">
      <div className="w-full max-w-md animate-slide-up">
        <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-lg shadow-slate-200/60">
          ...
          <h1 className="text-2xl font-bold text-slate-900 text-center mb-1">Mot de passe oublié ?</h1>
